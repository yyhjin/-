            ...
            <div class="modifyMenu">
                <div class="modifyForm">
                    ...
                    <div class="searchAddress">
                        <el-button round color="#e07c49" style="color: white" @click="execDaumPostcode()" class="btn_address">주소 검색</el-button><br />
                        ...
                        <el-input type="text" v-model="userinfo.extraAddress" id="extraAddress" placeholder="참고 항목" style="margin-top: 10px" />
                    </div>
                </div>
...
export default {
    setup() {
        ...
        return { userNo, userType, userinfo, open };
    },
    created() {
        getCustomer(
            this.userNo,
