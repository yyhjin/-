        ...
        <el-card class="card">
          ...
          <h5 style="text-align: right; color: red">{{ this.same }}</h5> -->
                    ...
                    <div class="searchAddress">
                        <el-button round color="#e07c49" style="color: white" @click="execDaumPostcode()" class="btn_address" size="small">주소 검색</el-button><br />
                        <!--<el-input type="text" v-model="postcode" placeholder="우편번호"/>-->
                        <el-input type="text" v-model="userinfo.address" id="address" placeholder="기본 주소" style="margin-top: 10px" disabled /><br />
                        <el-input type="text" v-model="userinfo.extraAddress" id="extraAddress" placeholder="참고 항목" style="margin-top: 10px" disabled />
                    </div>
                    <el-input type="text" v-model="userinfo.detailAddress" id="detailAddress" placeholder="상세 주소" @keyup.enter="cl_modify" style="margin-top: 10px" />
                </div>

                <div style="margin-top: 30px">
                    <el-button color="#42413e" style="width: 100px; color: white" class="btn_modify" @click="cl_modify">수정</el-button>
                ...
                oncomplete: (data) => {
                    ...
                    if (data.userSelectedType === "R") {
                        ...
                        if (data.buildingName !== "" && data.apartment === "Y") {
                            this.userinfo.extraAddress += this.userinfo.extraAddress !== "" ? `, ${data.buildingName}` : data.buildingName;
                        }
                        if (this.extraAddress !== "") {
