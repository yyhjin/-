        ...
        <div id="logged" hidden>
            ...
            <div id="session" style="display: none">
                <div id="session-header">
                    ...
                    <input class="btn btn-large btn-danger" type="button" id="buttonLeaveSession" @click="removeUser(); leaveSession()" value="Leave session" />
                </div>
                <!--
...
export default {
    ...
    methods: {
        ...
        removeUser() {
            this.httpPostRequest("http://localhost:8080/api-sessions/remove-user", { sessionName: this.sessionName, token: this.token, user: this.user }, "User couldn't be removed from session", (response) => {
                console.log(response);
