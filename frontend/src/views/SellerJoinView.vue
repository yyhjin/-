        ...
        <div class="registerMenu">
          <div class="inputRegister">
            ...
            <el-input
              ...
              v-model="seller_number"
              class="input_Snumber"
            />
            <el-button color="#FF6F61" round class="btn_sellerCheck" @click="cl_sellerCheck"
              >확인</el-button
            >
            ...
            <el-button color="#FF6F61" round class="btn_idCheck" @click="cl_idCheck"
              >중복 확인</el-button
            >
