        ...
        <el-card class="box-card" shadow="always">
            ...
            <div class="loginMenu">
                <div class="inputLogin">
                    <div style="text-align: left; margin: 25px 0px 10px 8px; font-size: 15px">아이디</div>
                    <el-input placeholder="아이디를 입력하세요" v-model="id" class="input_id" style="margin-bottom: 10px" />
                    <div style="text-align: left; margin: 20px 0px 10px 8px; font-size: 15px">비밀번호</div>
                    <el-input placeholder="비밀번호를 입력하세요" @keyup.enter="ck_login" v-model="password" class="input_pass" type="password" />
                </div>

                <div>
                    <el-button @click="ck_login()" color="#42413e" style="width: 100px" class="buttonLogin">로그인</el-button>
                </div>
            </div>
        </el-card>
        <!-- </el-space> -->
