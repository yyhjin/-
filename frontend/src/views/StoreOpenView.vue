        ...
        <div class="div_menu" style="margin-top: 80px">
          <div>
            ...
            <el-button
              ...
              style="background-color: #42413e; margin-top: 7px"
              >수정</el-button
            >
          </div>
    ...
    <el-card class="box-card1">
      <template #header>
        <el-scrollbar>
          <div class="scrollbar-flex-content">
            <el-button
              class="btn_item scrollbar-demo-item"
      ...
      <div style="text-align: center">
        ...
        <el-input
          ...
          style="width: 100px; margin-right: 50px"
        />
        <el-button style="color: black !important" @click="cl_add(Item)"
          >추가</el-button
        >
      </div>
    </el-card>
