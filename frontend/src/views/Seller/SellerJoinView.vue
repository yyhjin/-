            ...
            <div class="registerMenu">
                <div class="inputRegister">
                    <div style="display: inline-block; width: 100%; text-align: left">
                        ...
                        <el-button link class="btn_idCheck" @click="cl_busiCheck" type="danger" style="margin-top: 25px">중복 확인</el-button>
                    </div>
                    ...
                    <div style="display: inline-block; width: 100%; text-align: left">
                        ...
                        <el-button link class="btn_idCheck" @click="cl_idCheck" type="danger" style="margin-top: 25px">중복 확인</el-button>
                    </div>
                    ...
                    <div class="searchAddress">
                        <el-button round color="#e07c49" @click="execDaumPostcode()" class="btn_address">주소 검색</el-button><br />
                ...
                <div>
                    <el-button color="#42413e" style="width: 100px" round class="btn_register" @click="cl_register">회원가입</el-button>
