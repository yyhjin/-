                    ...
                    <el-row>
                        ...
                        <el-col :span="18" class="profile_register">
                            <div style="text-align: left">
                                ...
                                <h4 style="margin-right: 60px; float: right; display: inline-block; margin-top: 0px">업종 : {{ this.shopInfo.storeCategory }}</h4>
...
--------->
        ...
        <div v-if="isRegistered">
            ...
            <el-card class="div_card" @click="routerPush('store_bills', { storeNo: this.shopInfo.storeNo })">
                <h2>판매 내역</h2>
            </el-card>
            <!-- <el-row>
