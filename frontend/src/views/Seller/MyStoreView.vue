                    ...
                    <el-row>
                        ...
                        <el-col :span="18" class="profile_register">
                            <div style="text-align: left">
                                <h4 style="margin-top: -10px">상점명 : {{ this.shopInfo.storeName }}</h4>
                                <h4 style="margin-top: -10px">업종 : {{ this.shopInfo.storeCategory }}</h4>
                                <h4 style="margin-top: -10px; margin-bottom: -5px">위치 : {{ this.shopInfo.storeAddr }}</h4>
                            </div>
                        </el-col>
                    </el-row>
                </div>
...
--------->
            <div class="mystore_unregistered" v-else>
                ...
                <el-button round color="#e07c49" @click="routerPush('store_register')" style="color: white">등록하기</el-button>
            </div>
        </el-card>
        <div v-if="isRegistered">
            <el-card class="box-card" @click="cl_open()" style="margin-top: 20px; text-align: center">
                <h2>가게 오픈</h2>
            </el-card>
            <el-card
                class="box-card"
            ...
            <el-card class="box-card" @click="routerPush('store_menu', { storeNo: this.shopInfo.storeNo })" style="margin-top: 10px; text-align: center">
                <h2>메뉴 관리</h2>
            </el-card>
            <el-card class="box-card" @click="routerPush('store_bills', { storeNo: this.shopInfo.storeNo })" style="margin-top: 10px; text-align: center">
                <h2>판매 내역</h2>
            </el-card>
            <!-- <el-row>
