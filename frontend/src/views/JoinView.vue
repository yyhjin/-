      ...
      <div class="registerMenu">
        <div class="inputRegister">
          ...
          <div class="searchAddress">
            ...
            <el-input type="text" v-model="address" id="address" placeholder="주소" style="margin-top:10px"/><br>
            <el-input type="text" v-model="detailAddress" id="detailAddress" placeholder="상세주소" style="margin-top:10px"/>
            <el-input type="text" v-model="extraAddress" id="extraAddress" placeholder="참고항목" style="margin-top:10px"/>
          </div>
          <h5>생년월일</h5>
          <el-input
            placeholder="YYYY-MM-DD"
            v-model="birthday"
            class="input_birthday"/>
          <h5>성별(선택)</h5>
        ...
        <div>
          ...
          <el-button style="width: 100px" round class="btn_cancle">취소</el-button>
        </div>
      </div>
    </el-card>
  </el-space>
