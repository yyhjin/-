...
<div  class="firstDiv">
  <el-space wrap>
    <el-card class="card">
      <h1>회원가입</h1>
      <div class="selectType" style="margin : 40px 0px">
      ...
      <div class="registerMenu">
        ...
        <div>
          <el-button color="#FF6F61" style="width: 100px" round class="buttonLogin">회원가입</el-button>
          <el-button style="width: 100px" round class="buttonCancle">취소</el-button>
        </div>
      </div>
    </el-card>
  </el-space>
