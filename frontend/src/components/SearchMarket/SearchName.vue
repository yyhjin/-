<template>
    <div class="Div1">
        <el-input placeholder="시장 이름 검색" v-model="market_name" class="input_name" style="margin-top: 30px; width: 190px" /><br />
        <el-button color="#FF6F61" round class="btn_name" @click="cl_name" style="margin-top: 30px; margin-bottom: 10px">시장 검색</el-button>
    </div>
</template>
