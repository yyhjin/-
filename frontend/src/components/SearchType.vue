    ...
    <div class="div_market" v-for="item in storeList" v-bind:key="item">
      <el-card class="box-card" shadow="never">
        <div class="div_item">
          <img
            class="mk_img"
            src="@/assets/defaultshop.png"
            alt="상점사진"
            @click="cl_detail(item.no)"
            style="
              margin-top: 5px;
              margin-left: 10px;
              width: 60px;
          ...
          <div style="text-align: left; margin-top: -10px; padding-left: 90px">
  ...
  <el-dialog v-model="dialogVisible" title="상점 정보" width="90%">
    <el-descriptions :column="1" border>
      <el-descriptions-item
        ...
        width="150px"
        >{{ this.one_market.storeName }}</el-descriptions-item
      >
      <el-descriptions-item
        label="방 제목"
        label-align="center"
        align="center"
        >{{ this.one_market.storeSubject }}</el-descriptions-item
      >
      <el-descriptions-item
        label="소개글"
        label-align="center"
        align="center"
        >{{ this.one_market.storeIntro }}</el-descriptions-item
      >

      <el-descriptions-item label="업종" label-align="center" align="center">
        <el-tag size="small">{{ this.one_market.storeCategory }}</el-tag>
      </el-descriptions-item>
      <el-descriptions-item label="주소" label-align="center" align="center">{{
        this.one_market.storeAddr
      }}</el-descriptions-item>
      <el-descriptions-item
        label="전화 번호"
        label-align="center"
        align="center"
        >{{ this.one_market.storePhone }}</el-descriptions-item
      >
    </el-descriptions>
  </el-dialog>
</template>
